...
for ds in dataSets:
    ...
    for i in range(10):
        ...
        for z, data in enumerate(dbTest):
            ...
            # compare the prediction with the true label (located at data[4])
            # of the test instance to start calculating the accuracy.
            # --> add your Python code here

            class_predicted = clf.predict(sample_data)[0]
            true_label = 1
            if data[4] == "No":
                true_label = 2
            elif true_label == 1 and class_predicted == 1:
                true_positive += 1
            elif true_label == 2 and class_predicted == 2:
                true_negative += 1
            total += 1
